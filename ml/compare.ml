...
external abs_int: int abs_compare = "int" [@@bs.module "../common/compare.js"]
external abs_num: float abs_compare = "num" [@@bs.module "../common/compare.js"]
external abs_str: string abs_compare = "str" [@@bs.module "../common/compare.js"]
external abs_bool: bool abs_compare = "bool" [@@bs.module "../common/compare.js"]
